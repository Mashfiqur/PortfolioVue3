<template>
  ...
  <hr style="border: 1px solid red;">
    <div class="row d-flex mt-2 py-2" id="about">
      ...
      <div class="col-sm-8 glass">
          ...
          <p><b>Duration: </b> May 2015 - April 2020</p>
          <p><b>Result: </b> CGPA 3.55 Out of 4.00</p>
          <p><b>Distinction: </b> Cum Laude</p>
  ...
  <hr style="border: 1px solid red;">
    <div class="row display-flex mt-2 py-2" id="about">
      <div class="col-sm-4 d-flex">
        <img
          class="m-b-1 img-fluid img-rounded hidden-xs-down"
          src="images/BUET.JPG"
      ...
      <div class="col-sm-8 glass">
          ...
          <hr>
            <div class="text-left">
              ...
              <p><b>Duration: </b> June 2011 - May 2013</p>
              <p><b>Certificate: </b> Higher Secondary School Certificate</p>
              <p><b>Result: </b> GPA 5.00 Out of 5.00 </p>
  ...
  <hr style="border: 1px solid red;">
    <div class="row display-flex mt-2 py-2" id="about">
      ...
      <div class="col-sm-8 glass">
          ...
          <div class="text-left">
              <p><b>Group: </b>Science <span class="ml-5 pl-2"><b>Board:</b> Dhaka </span></p>
              <p><b>Duration: </b> January 2001 - March 2011</p>
              <p><b>Certificate: </b> Secondary School Certificate</p>
              <p><b>Result: </b> GPA 5.00 Out of 5.00 </p>
