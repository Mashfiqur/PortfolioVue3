  ...
  <div id="projects">
    <div class="container mt-4">
      <div class="row">
            ...
            v-bind:key="project.projectNo"
            >
            <single-project :data="project" />
            </div>
      </div>
    </div>
  </div>
...
<script>
import SingleProject from "./single-project.vue";
...
#project4 {
  background: #0d9cbd linear-gradient(19deg, #065466 0%, #9c09e0 100%);
}
