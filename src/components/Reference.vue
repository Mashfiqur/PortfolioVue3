...
<div class="row mt-5 d-inline-flex">
    ...
    <div class="thumbnail">
      <img height="350" src="images/KMM.JPG">
      <div class="caption">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img height="320" src="images/AZQ.JPG">
      <div class="caption">
...
.caption{background:rgba(10,10,10,0.7) ; color: wheat;}
